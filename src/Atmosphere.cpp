...
// ISO 9613-1 atmospheric absorption (Rindel 2024 reference implementation).
double Atmosphere::absorption_dB_per_m(double f) const {
  ...
  // saturation vapour pressure ratio, and molar conc. of water vapour h (%)
...
double Atmosphere::absorption_m(double f) const {
  // SPL attenuation (dB/m) -> energy coefficient (1/m): m = alpha / (10 log10 e)
